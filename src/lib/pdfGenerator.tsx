...
const RenderModern = ({ data, isPremium }: TemplateProps) => {
...
const RenderMinimal = ({ data, isPremium }: TemplateProps) => {
...
const RenderTech = ({ data, isPremium }: TemplateProps) => {
  const { personalInfo, summary, experience, education, skills, certifications } = data;
  return (
...
const RenderCreative = ({ data, isPremium }: TemplateProps) => {
  const { personalInfo, summary, experience, education, skills } = data;
  return (
...
const RenderAcademic = ({ data, isPremium }: TemplateProps) => {
  const { personalInfo, summary, experience, education, skills } = data;
  return (
...
export function ResumePDFDocument({ data, template = 'modern', isPremium = false }: ResumePDFDocumentProps) {
  return (
    <Document>
      {template === 'minimal' ? <RenderMinimal data={data} isPremium={isPremium} /> : 
       template === 'tech' ? <RenderTech data={data} isPremium={isPremium} /> : 
       template === 'creative' ? <RenderCreative data={data} isPremium={isPremium} /> :
       template === 'academic' ? <RenderAcademic data={data} isPremium={isPremium} /> :
       <RenderModern data={data} isPremium={isPremium} />}
    </Document>
  );
}
